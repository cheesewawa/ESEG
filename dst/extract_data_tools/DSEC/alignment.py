...
if __name__ == '__main__':
    ...
    train_images = ['zurich_city_00_a', 'zurich_city_01_a', 'zurich_city_02_a',
    ...
    parser.add_argument('--seqpath', type=str,
                        default='/NVME_id0/DVS_Data/DSEC/train_images/zurich_city_08_a')
    ...
    str_path = str(seqpath).replace('train_images', 'train_calibration')
    confpath = Path(str_path) / 'calibration' / 'cam_to_cam.yaml'
