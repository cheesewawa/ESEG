...
""""""
# --- Task ---
def colormap(semseg_num_classes):
    # task = settings['task']
    # semseg_num_classes = task['semseg_num_classes']
    if semseg_num_classes == 6:
        ...
        semseg_color_map[0] = [128, 64,128]
        semseg_color_map[1] = [70, 70, 70]
        semseg_color_map[2] = [220,220,  0]
        semseg_color_map[3] = [107,142, 35]
        semseg_color_map[4] = [220, 20, 60]
        semseg_color_map[5] = [  0,  0,142]

    elif semseg_num_classes == 11:
        semseg_ignore_label = 255
        semseg_class_names = ['background', 'building','fence','person','pole','road',
                                               'sidewalk','vegetation','car','wall','traffic sign']
        semseg_color_map = np.zeros((semseg_num_classes, 3), dtype=np.uint8)
        semseg_color_map[0] = [0, 0, 0]
        semseg_color_map[1] = [70, 70, 70]
        semseg_color_map[2] = [190, 153, 153]
        semseg_color_map[3] = [220, 20, 60]
        semseg_color_map[4] = [153, 153, 153]
        semseg_color_map[5] = [128, 64, 128]
        semseg_color_map[6] = [244, 35, 232]
        semseg_color_map[7] = [107, 142, 35]
        semseg_color_map[8] = [0, 0, 142]
        semseg_color_map[9] = [102, 102, 156]
        semseg_color_map[10] = [220, 220, 0]
    return semseg_color_map, semseg_ignore_label
""""""