...
sys.path.append("/home/undergrad/AyChihuahua/SAM/RGB_only_v0_pidinet/DDFpytorch/models")
from models.resnet_ori import resnet34
...
class DFF(nn.Module):
    def __init__(self,nclass = 19,pretrained = True,norm_layer=nn.BatchNorm2d,device = "cuda"):
        ...
        self.side5_ew = nn.Sequential(nn.Conv2d(512, nclass*4, 1, bias=True),
                                   norm_layer(nclass*4),
    ...
    def forward(self,x):
        ...
        return side5, fuse, f1, f2, f3, f4, f5
